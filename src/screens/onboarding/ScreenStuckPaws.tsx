...
// Stuck Paws onboarding slide.
// Saved 2026-05-05 — pulled from active onboarding flow but preserved for future use.
// Concept: rotting Paws stuck in a phone-shaped puddle, "Years on your phone: X",
// "Paws is stuck on the phone. Just like you. Tap Paws to break free." (5 taps to free Paws + advance)
export function ScreenStuckPaws({ goNext }: Props) {
