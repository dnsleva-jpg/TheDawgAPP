export interface Session {
  ...
  dayNumber?: number;           // days since program start (1-based)
  challengeCompleted?: boolean; // whether today's challenge was completed
  sessionType?: 'standard' | 'focusCheck' | 'walkMode';
  focusCheckNumber?: number;    // which Focus Check (1-23)
}
